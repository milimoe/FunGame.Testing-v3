...
using IM = FunGame.Core.Library.Module.ItemModule;

namespace Milimoe.FunGameTesting.OshimaGameModules
{
    public class ItemModule : IM
    {
        ...
        protected override Factory.EntityFactoryDelegate<Item> ItemFactory()
        {
            return (id, name, args) =>
            {
                return id switch
                {
                    ...
                    (long)AccessoryID.行军医箱1 => new 行军医箱1(),
                    (long)AccessoryID.行军医箱2 => new 行军医箱2(),
                    (long)AccessoryID.行军医箱3 => new 行军医箱3(),
                    (long)AccessoryID.共鸣核心1 => new 共鸣核心1(),
                    (long)AccessoryID.共鸣核心2 => new 共鸣核心2(),
                    (long)AccessoryID.共鸣核心3 => new 共鸣核心3(),
                    (long)AccessoryID.接力信标1 => new 接力信标1(),
                    (long)AccessoryID.接力信标2 => new 接力信标2(),
                    (long)AccessoryID.接力信标3 => new 接力信标3(),
                    (long)AccessoryID.应急装置1 => new 应急装置1(),
                    (long)AccessoryID.应急装置2 => new 应急装置2(),
                    (long)AccessoryID.应急装置3 => new 应急装置3(),
                    (long)AccessoryID.万能钥匙1 => new 万能钥匙1(),
                    (long)AccessoryID.万能钥匙2 => new 万能钥匙2(),
                    (long)AccessoryID.万能钥匙3 => new 万能钥匙3(),
                    (long)AccessoryID.节拍器1 => new 节拍器1(),
                    (long)AccessoryID.节拍器2 => new 节拍器2(),
                    (long)AccessoryID.节拍器3 => new 节拍器3(),
